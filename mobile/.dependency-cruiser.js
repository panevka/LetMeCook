  ...
  forbidden: [
    {
      ...
      comment: "internal modules may only be imported from within the same feature (api or internal)",
      severity: "error",
      from: {
        pathNot: "^features/([^/]+)/(api|internal)/"
      },
      to: {
        path: "^features/([^/]+)/internal/",
        pathNot: "^features/$1/(api|internal)/"
      }
    },
    {
      name: 'no-circular',
...
// generated: dependency-cruiser@17.3.8 on 2026-02-28T13:38:29.110Z
